...
socketio = SocketIO(app, cors_allowed_origins='*', manage_session=False, engineio_logger=True, ping_timeout=5, ping_interval=5)
ch_lst = []
...
class add_news(FlaskForm):
    ...
    description = TextAreaField("Текст новости", validators=[InputRequired("Поле не может быть пустым!")],
                                render_kw={'style': "width:500px; height:45;", "placeholder": "Текст новости"})
